  ...
  return (
    <div className="animate-pulse flex flex-col gap-8 p-4 md:p-0">
      ...
      <div className=" flex flex-col justify-center items-center gap-8 mb-8 mt-8 md:mt-0 md:block ">
        <div className="w-32 h-8 bg-gray-200 rounded mx-auto md:mx-0"></div>
        <div className="border border-gray-2 bg-gray-200 rounded-full md:hidden mb-4 w-[100px] h-[100px]"></div>
        <div className="border border-gray-2 bg-gray-200 text-[16px] w-[100px] font-bold md:hidden text-center h-[19px]"></div>
      </div>
      <form className="flex flex-col items-center w-full md:w-auto">
        ...
        <button
          type="submit"
          className="bg-gray-200 w-full md:w-[500px] h-[52px] text-white py-2 mt-[50px] rounded-full font-bold text-[16px] md:text-[18px]"
        ></button>
      </form>
    </div>
  );
