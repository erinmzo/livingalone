...
const GroupPostCardSkeleton = () => {
  return (
    <div className="relative text-gray-2 animate-pulse">
      ...
      <div className="relative aspect-video rounded-lg overflow-hidden border border-gray-2 bg-gray-2 w-full md:w-[60%]"></div>
      <div className="px-1 mt-[16px]">
        ...
        <h4 className=" truncate mt-[6px] w-[50%] bg-gray-2 rounded  h-6"></h4>
