    ...
    <InnerLayout>
      <div className="flex flex-col gap-5">
        <div className="flex gap-2">
          <label className="w-[86px] font-bold text-[20px] flex-none">제목</label>
          <input
            name="title"
        ...
        <div className="flex justify-between">
          <div className="flex gap-2 items-center">
            <label className="w-[86px] font-bold text-[20px] flex-none">공구기간</label>
            <div className="w-[380px] border-b-[1px] border-black flex gap-1 items-center">
              <label className="text-[12px]">마감일</label>
              <input name="endDate" type="date" value={endDate} onChange={onChangeInput} />
            </div>
          </div>
          <div className="flex gap-2">
            <label className="w-[78px] font-bold text-[20px] flex-none">공구인원</label>
            <input
              name="peopleNum"
              type="number"
        ...
        <div className="flex gap-2">
          <label className="w-[86px] font-bold text-[20px] flex-none">상품이름</label>
          <input
            name="item"
        ...
        <div className="flex gap-2 items-center">
          <label className="w-[86px] font-bold text-[20px] flex-none">공구가격</label>
          <input
            name="price"
            type="number"
            placeholder="숫자만 입력해주세요."
        ...
        <div className="flex gap-2 items-center">
          <label className="w-[86px] font-bold text-[20px] flex-none">링크</label>
          <input
            name="link"
      ...
      <div>
        <Editor
          initialValue={groupPost.content}
